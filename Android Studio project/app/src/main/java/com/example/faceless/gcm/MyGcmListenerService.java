...
public class MyGcmListenerService extends GcmListenerService {
        ...
        try {
            if (ChatActivity.isChatActivityResumed) {
                ...
                if (ChatActivity.chatActivityInstance != null) {
                    ChatActivity.chatActivityInstance.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ChatActivity.chatActivityInstance.addmessageToChatsListWhenReceivedThroughtGCM(message);
                        }
                    });
                }
            } else {
    ...
    private void sendNotification(String message) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(
                this).setSmallIcon(R.drawable.ic_launcher_app)
